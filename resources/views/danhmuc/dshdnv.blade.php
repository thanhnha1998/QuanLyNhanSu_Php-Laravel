                            ...
                            <div class="card">
                                ...
                                @endif
                                    ...
                                    <table class="table table-striped table-bordered table-hover" >
                                        ...
                                        <tbody>
                                            ...
                                            <tr class="even gradeC" align="center">
                                                ...
                                                <td>
                                                    <button type="button" class="btn btn-primary mb-2" data-toggle="modal" data-target=".bd-example-modal-lg"><i class="fa fa-eye"></i>
                                                        Xem
                                                    </button>
                                    ...
                                    <td>
                                        ...
                                        <a class="btn btn-primary mb-2" href="{{url('private/laphopdong/pdf/'.$hd->id_hopdong)}}" title="Xuất file pdf" target="_blank"> <i class="fa fa-edit"></i> Xuất file pdf</a>
